 ...
 */
float KDEFeatureItem::getMinAngle(const Polyline2D &polyline) const {
...
void KDEFeatureItem::scale(float scaleX, float scaleY, const QVector2D &orig) {
...
void KDEFeatureItem::imwrite(const QString filename) const {
